...
1.  Read the Introduction, Voting Patterns, and Conclusions sections of [this research article (Porter et al., 2005)](http://www.math250-s25.github.io/static/HouseOfRepresentatives.pdf). Based on the authors' explanation, what do the left singular vectors of their analysis represent? What do the right singular vectors represent?
